...
LOCAL_LDLIBS += -llog
LOCAL_CFLAGS += -I'extern/libil2cpp/il2cpp/libil2cpp' -DID='"BrokenController"' -DVERSION='"1.0.1"' -I'./shared' -I'./extern' -isystem'extern/monkecodegen/include'
